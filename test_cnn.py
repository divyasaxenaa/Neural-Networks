...
def test_append_maxpooling2d_layer():
    model = CNN()
    print("test_append_maxpooling2d_layer 1")
    model.add_input_layer(shape=(256, 256, 3), name="input0")
    print("test_append_maxpooling2d_layer 2")
    model.append_maxpooling2d_layer(pool_size=(2, 2), padding="same", strides=2, name='pooling')
    print("test_append_maxpooling2d_layer 3")
    input = np.zeros((10, 256, 256, 3))
    print("test_append_maxpooling2d_layer 4")
    out = model.predict(input)
    print("test_append_maxpooling2d_layer 5")
    print("test_append_maxpooling2d_layer out.shape",out.shape)
...
def test_get_weights_without_biases_1():
    ...
    for k in range(number_of_dense_layers):
        print("number_of_dense_layers", number_of_dense_layers)
        print("k", k)
        ...
        print("weights for Layer",k+1)
        print("previous_nodes,number_of_nodes[","]",previous_nodes,number_of_nodes)
...
def test_get_weights_without_biases_2():
    ...
    for k in range(number_of_conv_layers):
        ...
        print("number_of_filters !", number_of_filters)
        actual = my_cnn.get_weights_without_biases(layer_number=k+1)
...
def test_get_weights_without_biases_3():
    ...
    my_cnn.add_input_layer(shape=image_size,name="input")
    previous_depth=image_size[2]
    print("number_of_conv_layers",number_of_conv_layers)
    for k in range(number_of_conv_layers):
        number_of_filters = np.random.randint(3, 100)
        kernel_size= np.random.randint(3,9)
        my_cnn.append_conv2d_layer(num_of_filters=number_of_filters,
    ...
    actual = my_cnn.get_weights_without_biases(layer_number=0)
    print("number_of_filters 1*", actual)
    assert actual is None
    ...
    print("number_of_filters 2*", actual)
    assert actual is None
    print("number_of_filters 2.1*", actual)
    my_cnn.append_flatten_layer(name="flat1")
    actual=my_cnn.get_weights_without_biases(layer_name="flat1")
    print("number_of_filters 3*", actual)
    assert actual is None
    print("number_of_filters 30*", actual)
    ...
    for k in range(number_of_dense_layers):
        ...
        kernel_size = np.random.randint(3, 9)
        my_cnn.append_dense_layer(num_nodes=number_of_nodes)
        print("k+number_of_conv_layers+4 ",k+number_of_conv_layers+4)
...
# print("test_add_input_layer start")
# test_add_input_layer()
# print("test_add_input_layer stop")
# print("test_append_conv2d_layer start")
# test_append_conv2d_layer()
# print("test_append_conv2d_layer stop")
# print("test_append_maxpooling2d_layer start")
# test_append_maxpooling2d_layer()
# print("test_append_maxpooling2d_layer stop")
# print("test_add_flatten_layer start")
# test_add_flatten_layer()
# print("test_add_flatten_layer stop")
# print("test_append_dense_layer start")
# test_append_dense_layer()
# print("test_append_dense_layer stop")
# print("test_get_weights_without_biases_1 start")
# test_get_weights_without_biases_1()
# print("test_get_weights_without_biases_1 stop")
# print("test_get_weights_without_biases_2 start")
# test_get_weights_without_biases_2()
# print("test_get_weights_without_biases_2 stop")
# print("test_get_weights_without_biases_3 start")
# test_get_weights_without_biases_3()
# print("test_get_weights_without_biases_3 stop")
# print("test_get_biases_1 start")
# test_get_biases_1()
# print("test_get_biases_1 stop")
# print("test_get_biases_2 start")
# test_get_biases_2()
# print("test_get_biases_2 stop")
# print("test_set_weights_without_biases start")
# test_set_weights_without_biases()
# print("test_set_weights_without_biases stop")
# # print("test_predict start")
# # test_predict()
# # print("test_predict stop")
# print("test_load_and_save_model start")
# test_load_and_save_model()
# print("test_load_and_s9ave_model stop")
#
# print("test_predict start")
# test_predict()
